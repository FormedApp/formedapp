...
module.exports = {  
  activity1 : {
    ...
    scripture_text : 'Therefore, if anyone is in Christ, the new creation has come:[a] The old has gone, the new is here!',
